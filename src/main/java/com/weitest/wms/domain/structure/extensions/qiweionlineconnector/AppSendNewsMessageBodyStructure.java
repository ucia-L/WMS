...
/**
* auto generate AppSendNewsMessageBodyStructure structure
*
* @author sys
*/
...
public class AppSendNewsMessageBodyStructure {
    ...
    public Long agentid;
    public com.weitest.wms.domain.structure.extensions.qiweionlineconnector.NewsStructure news;
    ...
    public com.weitest.wms.domain.structure.extensions.qiweionlineconnector.NewsStructure getNews() {
        return news;
    }

    public void setNews(com.weitest.wms.domain.structure.extensions.qiweionlineconnector.NewsStructure news) {
        this.news = news;
    }
