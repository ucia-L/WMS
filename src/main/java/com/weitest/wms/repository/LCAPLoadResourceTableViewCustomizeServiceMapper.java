...
List<com.weitest.wms.domain.structure.anonymous.AnonymousStructure_EA050579F163467B7D2FD3E8C15362AF> getAnonymousStructure_D8CB63E646D19A8E127BF2A118560F92(@Param("size") Long size,@Param("sort") String sort,@Param("page") Long page,@Param("order") String order);
