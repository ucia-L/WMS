...
/**
* auto generate WHMGetWarehouseAreaOutboundTmpInfoByWarehouseIdCustomizeService Mapper
*
* @author sys
*/
public interface WHMGetWarehouseAreaOutboundTmpInfoByWarehouseIdCustomizeServiceMapper {
