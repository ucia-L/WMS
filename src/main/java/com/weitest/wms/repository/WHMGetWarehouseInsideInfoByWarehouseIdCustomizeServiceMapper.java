...
/**
* auto generate WHMGetWarehouseInsideInfoByWarehouseIdCustomizeService Mapper
*
* @author sys
*/
public interface WHMGetWarehouseInsideInfoByWarehouseIdCustomizeServiceMapper {
