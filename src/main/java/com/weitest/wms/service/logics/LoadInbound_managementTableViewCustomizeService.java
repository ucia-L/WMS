...
/**
* auto generate LoadInbound_managementTableViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadInbound_managementTableViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInbound_managementTableViewCustomizeServiceMapper loadInbound_managementTableViewCustomizeServiceMapper;

	public com.weitest.wms.domain.structure.anonymous.AnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87  loadInbound_managementTableView(Long page,Long size,String sort,String order) {
		...
		result=CommonFunctionUtil.createListPage(loadInbound_managementTableViewCustomizeServiceMapper.getAnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87(size,getTableField("AnonymousStructure_9C51235C084B53955268CCC880F52D83",sort),page,order), loadInbound_managementTableViewCustomizeServiceMapper.countAnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87(size,getTableField("AnonymousStructure_9C51235C084B53955268CCC880F52D83",sort),page,order).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87.class);
		return result;
	}
    ...
    static {
        ...
        if (structureTableColumnMap.get("AnonymousStructure_9C51235C084B53955268CCC880F52D83") == null) {
        structureTableColumnMap.put("AnonymousStructure_9C51235C084B53955268CCC880F52D83",new HashMap<String, String>());
        }
        tableColumnMap = structureTableColumnMap.get("AnonymousStructure_9C51235C084B53955268CCC880F52D83");
        ...
        if (structurePropFieldMap.get("AnonymousStructure_9C51235C084B53955268CCC880F52D83") == null) {
            structurePropFieldMap.put("AnonymousStructure_9C51235C084B53955268CCC880F52D83",new HashMap<String, List<String>>());
        }
         propColumnMap = structurePropFieldMap.get("AnonymousStructure_9C51235C084B53955268CCC880F52D83");
