...
/**
* auto generate GetSfQuantityCustomizeService logic
*
* @author sys
*/
@Service
public class GetSfQuantityCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GetSfQuantityCustomizeServiceMapper getSfQuantityCustomizeServiceMapper;

	public Long  getSfQuantity(Long sfID) {
		List<Long> variable1 = new ArrayList <>();
		Long result = 0L;
		variable1=getSfQuantityCustomizeServiceMapper.getSql1(sfID);
