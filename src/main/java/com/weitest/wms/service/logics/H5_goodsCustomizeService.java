...
/**
* auto generate H5_goodsCustomizeService logic
*
* @author sys
*/
@Service
public class H5_goodsCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private H5_goodsCustomizeServiceMapper h5_goodsCustomizeServiceMapper;

	public com.weitest.wms.domain.structure.anonymous.AnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87  h5_goods(GoodsEntity param1) {
		...
		result=CommonFunctionUtil.createListPage(h5_goodsCustomizeServiceMapper.getAnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87(param1), h5_goodsCustomizeServiceMapper.countAnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87(param1).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_066A0DCCF9CBA9BEF52F6A44E6C77E87.class);
		return result;
	}
