...
/**
* auto generate GetQuantityOfShelfCustomizeService logic
*
* @author sys
*/
@Service
public class GetQuantityOfShelfCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GetQuantityOfShelfCustomizeServiceMapper getQuantityOfShelfCustomizeServiceMapper;

	public Long  getQuantityOfShelf(Long shelfId) {
		Long result = 0L;
		result=getQuantityOfShelfCustomizeServiceMapper.getSql1(shelfId);
		return result;
	}
