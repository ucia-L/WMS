...
/**
* auto generate GetQuantityOfWACustomizeService logic
*
* @author sys
*/
@Service
public class GetQuantityOfWACustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GetQuantityOfWACustomizeServiceMapper getQuantityOfWACustomizeServiceMapper;

	public Long  getQuantityOfWA(Long waId) {
		Long result = 0L;
		result=getQuantityOfWACustomizeServiceMapper.getSql1(waId);
		return result;
	}
