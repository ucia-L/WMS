...
/**
* auto generate GetMessageNumByApplyStatusCustomizeService logic
*
* @author sys
*/
@Service
public class GetMessageNumByApplyStatusCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GetMessageNumByApplyStatusCustomizeServiceMapper getMessageNumByApplyStatusCustomizeServiceMapper;

	public Long  getMessageNumByApplyStatus(MessageCategoryEnum category) {
		Long result = 0L;
		result=getMessageNumByApplyStatusCustomizeServiceMapper.getStructure1(category);
		return result;
	}
