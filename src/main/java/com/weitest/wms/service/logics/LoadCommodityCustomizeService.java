...
/**
* auto generate LoadCommodityCustomizeService logic
*
* @author sys
*/
@Service
public class LoadCommodityCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadCommodityCustomizeServiceMapper loadCommodityCustomizeServiceMapper;

	public List<com.weitest.wms.domain.structure.anonymous.AnonymousStructure_D3A798E5313781AC13C96C5E0CDD841E>  loadCommodity(Long warehouse_id) {
		List<com.weitest.wms.domain.structure.anonymous.AnonymousStructure_D3A798E5313781AC13C96C5E0CDD841E> result = new ArrayList <>();
		result=CommonFunctionUtil.createListPage(loadCommodityCustomizeServiceMapper.getAnonymousStructure_09BDCBA976A138647CE5FAE1CFBDB3A1(warehouse_id), loadCommodityCustomizeServiceMapper.countAnonymousStructure_09BDCBA976A138647CE5FAE1CFBDB3A1(warehouse_id).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_09BDCBA976A138647CE5FAE1CFBDB3A1.class).list;
		return result;
	}
