...
/**
* auto generate GetWaQuantityCustomizeService logic
*
* @author sys
*/
@Service
public class GetWaQuantityCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GetWaQuantityCustomizeServiceMapper getWaQuantityCustomizeServiceMapper;

	public Long  getWaQuantity(Long waID) {
		List<Long> variable1 = new ArrayList <>();
		Long result = 0L;
		variable1=getWaQuantityCustomizeServiceMapper.getSql1(waID);
