...
/**
* auto generate GoodscheckFinishInspectionCustomizeService logic
*
* @author sys
*/
@Service
public class GoodscheckFinishInspectionCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private GoodscheckFinishInspectionCustomizeServiceMapper goodscheckFinishInspectionCustomizeServiceMapper;

	public Boolean  goodscheckFinishInspection(Long OrderID) {
		Boolean result = false;
		result=(CommonFunctionUtil.createListPage(goodscheckFinishInspectionCustomizeServiceMapper.getAnonymousStructure_4EE7EE1E30E7881C7AED96E05B24EEE9(OrderID), goodscheckFinishInspectionCustomizeServiceMapper.countAnonymousStructure_4EE7EE1E30E7881C7AED96E05B24EEE9(OrderID).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_4EE7EE1E30E7881C7AED96E05B24EEE9.class).total.equals(0L));
		return result;
	}
