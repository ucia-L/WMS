...
public class LCAPIsExistRoleIdCustomizeService {
	...
	public Boolean  lCAPIsExistRoleId(Long roleId) {
		...
		variable1=CommonFunctionUtil.createListPage(lCAPIsExistRoleIdCustomizeServiceMapper.getAnonymousStructure_CAC5152BAE2C91DD609E3DFEE343ACC6(), lCAPIsExistRoleIdCustomizeServiceMapper.countAnonymousStructure_CAC5152BAE2C91DD609E3DFEE343ACC6().intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_CAC5152BAE2C91DD609E3DFEE343ACC6.class);
		result=false;
		for(Long i = 0L; i < CommonFunctionUtil.length(variable1.list); i++ ) {
			com.weitest.wms.domain.structure.anonymous.AnonymousStructure_70791B893F53C2EFB9E501591763B020  item = variable1.list.get(i.intValue());
