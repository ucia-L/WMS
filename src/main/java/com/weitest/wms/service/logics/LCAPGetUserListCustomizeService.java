...
/**
* auto generate LCAPGetUserListCustomizeService logic
*
* @author sys
*/
@Service
public class LCAPGetUserListCustomizeService {
	...
	@Autowired private LCAPGetUserListCustomizeServiceMapper lCAPGetUserListCustomizeServiceMapper;

	public com.weitest.wms.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632  lCAPGetUserList(String queryParam) {
		...
		result=CommonFunctionUtil.createListPage(lCAPGetUserListCustomizeServiceMapper.getAnonymousStructure_90BB04F104917B26166C550B4A1B0632(queryParam), lCAPGetUserListCustomizeServiceMapper.countAnonymousStructure_90BB04F104917B26166C550B4A1B0632(queryParam).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632.class);
		return result;
	}
