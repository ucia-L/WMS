...
/**
* auto generate NumberGetGroupByTimeCustomizeService logic
*
* @author sys
*/
@Service
public class NumberGetGroupByTimeCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private NumberGetGroupByTimeCustomizeServiceMapper numberGetGroupByTimeCustomizeServiceMapper;

	public List<com.weitest.wms.domain.structure.anonymous.AnonymousStructure_77D54F32F3F9CC14A0EA5BBAD9D1D9BE>  numberGetGroupByTime(Boolean InOrOut,CategoryEnum category) {
		List<com.weitest.wms.domain.structure.anonymous.AnonymousStructure_77D54F32F3F9CC14A0EA5BBAD9D1D9BE> result = new ArrayList <>();
		if(InOrOut) {
			result=numberGetGroupByTimeCustomizeServiceMapper.getSql1(category);
		} else {
			result=numberGetGroupByTimeCustomizeServiceMapper.getSql2(category);
		}
		return result;
	}
