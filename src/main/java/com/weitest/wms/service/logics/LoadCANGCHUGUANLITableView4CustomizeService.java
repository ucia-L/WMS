...
/**
* auto generate LoadCANGCHUGUANLITableView4CustomizeService logic
*
* @author sys
*/
@Service
public class LoadCANGCHUGUANLITableView4CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadCANGCHUGUANLITableView4CustomizeServiceMapper loadCANGCHUGUANLITableView4CustomizeServiceMapper;

	public com.weitest.wms.domain.structure.anonymous.AnonymousStructure_BC7B3AE84F9C5B2486014DB3333180BF  loadCANGCHUGUANLITableView4(Long page,Long size,String sort,String order,GoodsEntity filter) {
		...
		result=CommonFunctionUtil.createListPage(loadCANGCHUGUANLITableView4CustomizeServiceMapper.getAnonymousStructure_BC7B3AE84F9C5B2486014DB3333180BF(filter,size,getTableField("AnonymousStructure_46B102641248613FF08FAE8B2E5F02F5",sort),page,order), loadCANGCHUGUANLITableView4CustomizeServiceMapper.countAnonymousStructure_BC7B3AE84F9C5B2486014DB3333180BF(filter,size,getTableField("AnonymousStructure_46B102641248613FF08FAE8B2E5F02F5",sort),page,order).intValue(), com.weitest.wms.domain.structure.anonymous.AnonymousStructure_BC7B3AE84F9C5B2486014DB3333180BF.class);
		return result;
	}
