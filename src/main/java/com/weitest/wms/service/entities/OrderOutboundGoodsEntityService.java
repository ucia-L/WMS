...
import com.weitest.wms.repository.entities.OrderOutboundGoodsEntityMapper;
...
/**
* auto generate OrderOutboundGoodsEntity ServiceImpl
*
* @author sys
*/
@Service
public class OrderOutboundGoodsEntityService extends AbstractService {
    @Resource
    private OrderOutboundGoodsEntityMapper mapper;
    @Resource
    ...
    public OrderOutboundGoodsEntityService() {
        entityFieldNameTitleMap.put("id", "售后出库编号");
        entityFieldTitleNameMap.put("售后出库编号", "id");
        ...
        entityFieldNameTitleMap.put("warehouse_name", "仓库名");
        entityFieldTitleNameMap.put("仓库名", "warehouse_name");
        entityFiledColumnNameMap.put("warehouse_name", "warehouseName");
        entityFieldNameTitleMap.put("warehousearea_name", "货区名");
        entityFieldTitleNameMap.put("货区名", "warehousearea_name");
        entityFiledColumnNameMap.put("warehousearea_name", "warehouseareaName");
        entityFieldNameTitleMap.put("shelf_name", "货架名");
        entityFieldTitleNameMap.put("货架名", "shelf_name");
        entityFiledColumnNameMap.put("shelf_name", "shelfName");
        entityFieldNameTitleMap.put("order_id", "售后订单编号");
        entityFieldTitleNameMap.put("售后订单编号", "order_id");
    ...
    **/
    ...
    public OrderOutboundGoodsEntity create(OrderOutboundGoodsEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OrderOutboundGoodsEntity> batchCreate(List<OrderOutboundGoodsEntity> entities) {
        ...
        // fill default value
        for (OrderOutboundGoodsEntity entity : entities) {
            paramValidate(entity);
        }
    ...
    **/
    @Transactional
    public OrderOutboundGoodsEntity update(OrderOutboundGoodsEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "OrderOutboundGoodsEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OrderOutboundGoodsEntity> batchUpdate(List<OrderOutboundGoodsEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<OrderOutboundGoodsEntity> updateEntities = new ArrayList<>(entities.size());
        for (OrderOutboundGoodsEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        OrderOutboundGoodsEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("OrderOutboundGoods", "OrderOutboundGoods", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<OrderOutboundGoodsEntity>  entities = mapper.selectList(inQueryFilter);
        for (OrderOutboundGoodsEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public OrderOutboundGoodsEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<OrderOutboundGoodsEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<OrderOutboundGoodsEntity> data = ExcelUtil.read(file.getInputStream(), type, OrderOutboundGoodsEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<OrderOutboundGoodsEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, OrderOutboundGoodsEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + OrderOutboundGoodsEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public OrderOutboundGoodsEntity createOrUpdate(OrderOutboundGoodsEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            OrderOutboundGoodsEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                paramValidate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(OrderOutboundGoodsEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
