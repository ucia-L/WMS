...
import com.weitest.wms.repository.entities.OrdersEntityMapper;
...
/**
* auto generate OrdersEntity ServiceImpl
*
* @author sys
*/
@Service
public class OrdersEntityService extends AbstractService {
    @Resource
    private OrdersEntityMapper mapper;
    @Resource
    ...
    public OrdersEntityService() {
        entityFieldNameTitleMap.put("id", "订单主键");
        entityFieldTitleNameMap.put("订单主键", "id");
        ...
        entityFieldNameTitleMap.put("customer_name", "客户名称");
        entityFieldTitleNameMap.put("客户名称", "customer_name");
        ...
        entityFieldNameTitleMap.put("expected_date", "预计到货时间");
        entityFieldTitleNameMap.put("预计到货时间", "expected_date");
        entityFiledColumnNameMap.put("expected_date", "expectedDate");
        entityFieldNameTitleMap.put("arrival_date", "实际到货时间");
        entityFieldTitleNameMap.put("实际到货时间", "arrival_date");
        entityFiledColumnNameMap.put("arrival_date", "arrivalDate");
        entityFieldNameTitleMap.put("notes", "备注");
        entityFieldTitleNameMap.put("备注", "notes");
        entityFiledColumnNameMap.put("notes", "notes");
        entityFieldNameTitleMap.put("status", "订单状态");
        entityFieldTitleNameMap.put("订单状态", "status");
        entityFiledColumnNameMap.put("status", "status");
        entityFieldNameTitleMap.put("refuse_reason", "拒单说明");
        entityFieldTitleNameMap.put("拒单说明", "refuse_reason");
        entityFiledColumnNameMap.put("refuse_reason", "refuseReason");
        entityFieldNameTitleMap.put("id_tag", "订单编号");
        entityFieldTitleNameMap.put("订单编号", "id_tag");
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OrdersEntity> batchCreate(List<OrdersEntity> entities) {
    ...
    **/
    @Transactional
    public OrdersEntity update(OrdersEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "OrdersEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OrdersEntity> batchUpdate(List<OrdersEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<OrdersEntity> updateEntities = new ArrayList<>(entities.size());
        for (OrdersEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        OrdersEntity entity = mapper.selectOne( id ); 
    ...
    **/
    public List<OrdersEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<OrdersEntity> data = ExcelUtil.read(file.getInputStream(), type, OrdersEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<OrdersEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, OrdersEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + OrdersEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public OrdersEntity createOrUpdate(OrdersEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            OrdersEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(OrdersEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
