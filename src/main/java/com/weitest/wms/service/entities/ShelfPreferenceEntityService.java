...
import com.weitest.wms.repository.entities.ShelfPreferenceEntityMapper;
...
/**
* auto generate ShelfPreferenceEntity ServiceImpl
*
* @author sys
*/
@Service
public class ShelfPreferenceEntityService extends AbstractService {
    @Resource
    private ShelfPreferenceEntityMapper mapper;
    @Resource
    ...
    public ShelfPreferenceEntityService() {
        entityFieldNameTitleMap.put("id", "主键");
        entityFieldTitleNameMap.put("主键", "id");
        entityFiledColumnNameMap.put("id", "id");
        entityFieldNameTitleMap.put("name", "偏好名称");
        entityFieldTitleNameMap.put("偏好名称", "name");
    ...
    **/
    ...
    public ShelfPreferenceEntity create(ShelfPreferenceEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ShelfPreferenceEntity> batchCreate(List<ShelfPreferenceEntity> entities) {
        ...
        // fill default value
        for (ShelfPreferenceEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            paramValidate(entity);
        }
    ...
    **/
    @Transactional
    public ShelfPreferenceEntity update(ShelfPreferenceEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "ShelfPreferenceEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ShelfPreferenceEntity> batchUpdate(List<ShelfPreferenceEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<ShelfPreferenceEntity> updateEntities = new ArrayList<>(entities.size());
        for (ShelfPreferenceEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        ShelfPreferenceEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("ShelfPreference", "ShelfPreference", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<ShelfPreferenceEntity>  entities = mapper.selectList(inQueryFilter);
        for (ShelfPreferenceEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public ShelfPreferenceEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<ShelfPreferenceEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<ShelfPreferenceEntity> data = ExcelUtil.read(file.getInputStream(), type, ShelfPreferenceEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<ShelfPreferenceEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, ShelfPreferenceEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + ShelfPreferenceEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public ShelfPreferenceEntity createOrUpdate(ShelfPreferenceEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            ShelfPreferenceEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                paramValidate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(ShelfPreferenceEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
