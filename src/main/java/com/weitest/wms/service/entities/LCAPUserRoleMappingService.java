...
import com.weitest.wms.repository.entities.LCAPUserRoleMappingMapper;
...
/**
* auto generate LCAPUserRoleMapping ServiceImpl
*
* @author sys
*/
@Service
public class LCAPUserRoleMappingService extends AbstractService {
    ...
    public LCAPUserRoleMappingService() {
        ...
        entityFiledColumnNameMap.put("roleId", "roleId");
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPUserRoleMapping", "LCAPUserRoleMapping_79f632", "id", "id"))
