...
import com.weitest.wms.repository.entities.LCAPPerResMappingMapper;
...
/**
* auto generate LCAPPerResMapping ServiceImpl
*
* @author sys
*/
@Service
public class LCAPPerResMappingService extends AbstractService {
    ...
    public LCAPPerResMappingService() {
        ...
        entityFiledColumnNameMap.put("permissionId", "permissionId");
        entityFieldNameTitleMap.put("resourceId", "资源唯一ID");
        entityFieldTitleNameMap.put("资源唯一ID", "resourceId");
        entityFiledColumnNameMap.put("resourceId", "resourceId");
    }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPPerResMapping", "LCAPPerResMapping_79f632", "id", "id"))
