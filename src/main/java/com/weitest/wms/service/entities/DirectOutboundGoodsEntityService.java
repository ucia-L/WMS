...
import com.weitest.wms.repository.entities.DirectOutboundGoodsEntityMapper;
...
/**
* auto generate DirectOutboundGoodsEntity ServiceImpl
*
* @author sys
*/
@Service
public class DirectOutboundGoodsEntityService extends AbstractService {
    @Resource
    private DirectOutboundGoodsEntityMapper mapper;
    @Resource
    ...
    public DirectOutboundGoodsEntityService() {
        entityFieldNameTitleMap.put("id", "出库编号");
        entityFieldTitleNameMap.put("出库编号", "id");
        ...
        entityFieldNameTitleMap.put("outboundCount", "出库数量");
        entityFieldTitleNameMap.put("出库数量", "outboundCount");
        entityFiledColumnNameMap.put("outboundCount", "outboundCount");
        entityFieldNameTitleMap.put("outboundDate", "出库时间");
        entityFieldTitleNameMap.put("出库时间", "outboundDate");
        entityFiledColumnNameMap.put("outboundDate", "outboundDate");
        entityFieldNameTitleMap.put("warehouse_name", "仓库名称");
        entityFieldTitleNameMap.put("仓库名称", "warehouse_name");
        entityFiledColumnNameMap.put("warehouse_name", "warehouseName");
        entityFieldNameTitleMap.put("warehousearea_name", "货区名称");
        entityFieldTitleNameMap.put("货区名称", "warehousearea_name");
        entityFiledColumnNameMap.put("warehousearea_name", "warehouseareaName");
        entityFieldNameTitleMap.put("shelf_name", "货架名称");
        entityFieldTitleNameMap.put("货架名称", "shelf_name");
        entityFiledColumnNameMap.put("shelf_name", "shelfName");
    }
    ...
    **/
    ...
    public DirectOutboundGoodsEntity create(DirectOutboundGoodsEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<DirectOutboundGoodsEntity> batchCreate(List<DirectOutboundGoodsEntity> entities) {
        ...
        // fill default value
        for (DirectOutboundGoodsEntity entity : entities) {
            paramValidate(entity);
        }
    ...
    **/
    @Transactional
    public DirectOutboundGoodsEntity update(DirectOutboundGoodsEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "DirectOutboundGoodsEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<DirectOutboundGoodsEntity> batchUpdate(List<DirectOutboundGoodsEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<DirectOutboundGoodsEntity> updateEntities = new ArrayList<>(entities.size());
        for (DirectOutboundGoodsEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        DirectOutboundGoodsEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("DirectOutboundGoods", "DirectOutboundGoods", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<DirectOutboundGoodsEntity>  entities = mapper.selectList(inQueryFilter);
        for (DirectOutboundGoodsEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public DirectOutboundGoodsEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<DirectOutboundGoodsEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<DirectOutboundGoodsEntity> data = ExcelUtil.read(file.getInputStream(), type, DirectOutboundGoodsEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<DirectOutboundGoodsEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, DirectOutboundGoodsEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + DirectOutboundGoodsEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public DirectOutboundGoodsEntity createOrUpdate(DirectOutboundGoodsEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, DirectOutboundGoodsEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            DirectOutboundGoodsEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                paramValidate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(DirectOutboundGoodsEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
