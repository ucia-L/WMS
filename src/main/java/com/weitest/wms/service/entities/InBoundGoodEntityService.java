...
import com.weitest.wms.repository.entities.InBoundGoodEntityMapper;
...
/**
* auto generate InBoundGoodEntity ServiceImpl
*
* @author sys
*/
@Service
public class InBoundGoodEntityService extends AbstractService {
    @Resource
    private InBoundGoodEntityMapper mapper;
    @Resource
    ...
    public InBoundGoodEntityService() {
        ...
        entityFieldNameTitleMap.put("inbound_order_id", "入库订单编号");
        entityFieldTitleNameMap.put("入库订单编号", "inbound_order_id");
        entityFiledColumnNameMap.put("inbound_order_id", "inboundOrderId");
    ...
    **/
    ...
    public InBoundGoodEntity create(InBoundGoodEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<InBoundGoodEntity> batchCreate(List<InBoundGoodEntity> entities) {
        ...
        // fill default value
        for (InBoundGoodEntity entity : entities) {
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional
    public InBoundGoodEntity update(InBoundGoodEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "InBoundGoodEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<InBoundGoodEntity> batchUpdate(List<InBoundGoodEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<InBoundGoodEntity> updateEntities = new ArrayList<>(entities.size());
        for (InBoundGoodEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        InBoundGoodEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("InBoundGood", "InBoundGood", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<InBoundGoodEntity>  entities = mapper.selectList(inQueryFilter);
        for (InBoundGoodEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public InBoundGoodEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<InBoundGoodEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<InBoundGoodEntity> data = ExcelUtil.read(file.getInputStream(), type, InBoundGoodEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<InBoundGoodEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, InBoundGoodEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + InBoundGoodEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public InBoundGoodEntity createOrUpdate(InBoundGoodEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, InBoundGoodEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            InBoundGoodEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(InBoundGoodEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
