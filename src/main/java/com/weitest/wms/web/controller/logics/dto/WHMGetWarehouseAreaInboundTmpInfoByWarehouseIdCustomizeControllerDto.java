...
/**
* auto generate WHMGetWarehouseAreaInboundTmpInfoByWarehouseIdCustomizeControllerDto
*
* @author sys
*/
public class WHMGetWarehouseAreaInboundTmpInfoByWarehouseIdCustomizeControllerDto {
