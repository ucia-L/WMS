...
import com.weitest.wms.service.entities.ApplicationEntityService;
...
/**
* auto generate ApplicationEntity controller
*
* @author sys
*/
@RestController
public class ApplicationEntityController {
    ...
    **/
    ...
    public ApiReturn<ApplicationEntity> create(@RequestBody ApplicationEntity body) {
    ...
    **/
    @PostMapping("/api/application/batch")
    public ApiReturn<List<ApplicationEntity>> batchCreate(@RequestBody List<ApplicationEntity> body) {
    ...
    **/
    ...
    public ApiReturn<ApplicationEntity> update(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
        ApplicationEntity entity = JacksonUtils.fromJson(map, ApplicationEntity.class);
    ...
    **/
    @PutMapping("/api/application/batch")
    public ApiReturn<List<ApplicationEntity>> batchUpdate(@RequestBody EntityFilter filter) {
        ...
        for (Map map : filter.getEntities()) {
            entities.add(JacksonUtils.fromJson(map, ApplicationEntity.class));
        }
    ...
    **/
    @DeleteMapping("/api/application/batch")
    ...
    **/
    ...
    public ApiReturn<ApplicationEntity> get( @RequestParam(required = true) Long id ) { 
    ...
    **/
    @PostMapping("/api/application/createOrUpdate")
    public ApiReturn<ApplicationEntity> createOrUpdate(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
    ...
    **/
    @DeleteMapping("/api/application/by")
