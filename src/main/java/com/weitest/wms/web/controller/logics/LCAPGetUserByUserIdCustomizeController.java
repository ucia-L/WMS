...
public ApiReturn<LCAPUser> lCAPGetUserByUserId(@RequestBody LCAPGetUserByUserIdCustomizeControllerDto lCAPGetUserByUserIdCustomizeControllerDto) throws Exception {
 return ApiReturn.of(lCAPGetUserByUserIdCustomizeService.lCAPGetUserByUserId(lCAPGetUserByUserIdCustomizeControllerDto.getUserId()));
}
}
