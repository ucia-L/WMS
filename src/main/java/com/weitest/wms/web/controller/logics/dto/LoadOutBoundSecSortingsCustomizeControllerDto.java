...
/**
* auto generate LoadOutBoundSecSortingsCustomizeControllerDto
*
* @author sys
*/
public class LoadOutBoundSecSortingsCustomizeControllerDto {
    
    public OutboundPackingEntity packingFilter;
    
    public OutBoundSecSortingEntity sortingFilter;
    ...
    public OutBoundSecSortingEntity getSortingFilter() {
        return sortingFilter;
    }

    public void setSortingFilter(OutBoundSecSortingEntity sortingFilter) {
