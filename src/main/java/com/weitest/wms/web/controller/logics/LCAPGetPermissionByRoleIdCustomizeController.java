...
public ApiReturn<List<LCAPPermission>> lCAPGetPermissionByRoleId(@RequestBody LCAPGetPermissionByRoleIdCustomizeControllerDto lCAPGetPermissionByRoleIdCustomizeControllerDto) throws Exception {
 return ApiReturn.of(lCAPGetPermissionByRoleIdCustomizeService.lCAPGetPermissionByRoleId(lCAPGetPermissionByRoleIdCustomizeControllerDto.getRoleId()));
}
}
