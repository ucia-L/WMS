...
import com.weitest.wms.service.entities.CommodityEntityService;
...
/**
* auto generate CommodityEntity controller
*
* @author sys
*/
@RestController
public class CommodityEntityController {
    @Resource
    private CommodityEntityService service;

    /**
    * auto gen create method
    **/
    @PostMapping("/api/commodity")
    public ApiReturn<CommodityEntity> create(@RequestBody CommodityEntity body) {
    ...
    **/
    @PostMapping("/api/commodity/batch")
    public ApiReturn<List<CommodityEntity>> batchCreate(@RequestBody List<CommodityEntity> body) {
    ...
    **/
    @PutMapping("/api/commodity")
    public ApiReturn<CommodityEntity> update(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
        CommodityEntity entity = JacksonUtils.fromJson(map, CommodityEntity.class);
    ...
    **/
    @PutMapping("/api/commodity/batch")
    public ApiReturn<List<CommodityEntity>> batchUpdate(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntities() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        List<String> updateFields = filter.getProperties();
        List<CommodityEntity> entities = new ArrayList<>();
        for (Map map : filter.getEntities()) {
            entities.add(JacksonUtils.fromJson(map, CommodityEntity.class));
        }
    ...
    **/
    @DeleteMapping("/api/commodity/batch")
    ...
    **/
    ...
    public ApiReturn<CommodityEntity> get( @RequestParam(required = true) Long id ) { 
    ...
    **/
    @PostMapping("/api/commodity/import")
    ...
    **/
    @PostMapping("/api/commodity/createOrUpdate")
    public ApiReturn<CommodityEntity> createOrUpdate(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
    ...
    **/
    @DeleteMapping("/api/commodity/by")
