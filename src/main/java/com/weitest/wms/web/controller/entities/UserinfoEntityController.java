...
import com.weitest.wms.service.entities.UserinfoEntityService;
...
/**
* auto generate UserinfoEntity controller
*
* @author sys
*/
@RestController
public class UserinfoEntityController {
    @Resource
    private UserinfoEntityService service;

    /**
    * auto gen create method
    **/
    @PostMapping("/api/userinfo")
    public ApiReturn<UserinfoEntity> create(@RequestBody UserinfoEntity body) {
    ...
    **/
    @PostMapping("/api/userinfo/batch")
    public ApiReturn<List<UserinfoEntity>> batchCreate(@RequestBody List<UserinfoEntity> body) {
    ...
    **/
    ...
    public ApiReturn<UserinfoEntity> update(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
        UserinfoEntity entity = JacksonUtils.fromJson(map, UserinfoEntity.class);
    ...
    **/
    @PutMapping("/api/userinfo/batch")
    public ApiReturn<List<UserinfoEntity>> batchUpdate(@RequestBody EntityFilter filter) {
        ...
        for (Map map : filter.getEntities()) {
            entities.add(JacksonUtils.fromJson(map, UserinfoEntity.class));
        }
    ...
    **/
    @DeleteMapping("/api/userinfo/batch")
    ...
    **/
    ...
    public ApiReturn<UserinfoEntity> get( @RequestParam(required = true) Long id ) { 
    ...
    **/
    @PostMapping("/api/userinfo/import")
    ...
    **/
    @PostMapping("/api/userinfo/createOrUpdate")
    public ApiReturn<UserinfoEntity> createOrUpdate(@RequestBody EntityFilter filter) {
        if (filter == null || filter.getEntity() == null) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "");
        }
        Map map = filter.getEntity();
