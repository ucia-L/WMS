...
/**
* auto generate PutawayCustomizeControllerDto
*
* @author sys
*/
public class PutawayCustomizeControllerDto {
    ...
    public String getChangeShelf() {
        return ChangeShelf;
    }

    public void setChangeShelf(String ChangeShelf) {
        this.ChangeShelf = ChangeShelf;
    }
