...
/**
* auto generate Lcap_authCreateTokenController logic
*
* @author sys
*/
@RestController
...
public ApiReturn<Boolean> createToken(@RequestBody Lcap_authCreateTokenControllerDto lcap_authCreateTokenControllerDto) throws Exception {
 return ApiReturn.of(com.netease.lowcode.auth.LCAPAuthService.createToken(lcap_authCreateTokenControllerDto.getLcapUser()));
}
}
