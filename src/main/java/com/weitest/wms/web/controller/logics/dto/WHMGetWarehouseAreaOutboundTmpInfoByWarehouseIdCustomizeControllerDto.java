...
/**
* auto generate WHMGetWarehouseAreaOutboundTmpInfoByWarehouseIdCustomizeControllerDto
*
* @author sys
*/
public class WHMGetWarehouseAreaOutboundTmpInfoByWarehouseIdCustomizeControllerDto {
