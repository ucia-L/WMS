...
/**
* auto generate Lcap_permissionUploadResourceController logic
*
* @author sys
*/
@RestController
...
public ApiReturn<Boolean> uploadResource(@RequestBody Lcap_permissionUploadResourceControllerDto lcap_permissionUploadResourceControllerDto) throws Exception {
 return ApiReturn.of(com.netease.lowcode.permission.LCAPPermissionService.uploadResource(lcap_permissionUploadResourceControllerDto.getResourceMetaDataCollect()));
}
}
